    ...
    <div class="details-section">
      ...
      <table class="financial-table">
        ...
        <tbody>
          ...
          <tr>
            <td>إجمالي أرباح المساهم</td>
            <td>{{إجمالي_أرباح_المساهم}}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>المدخرات المستحقة للمساهم (تُصرف منفصلة)</td>
            <td>{{المدخرات_المستحقة_للمساهم}}</td>
          </tr>
          <tr class="total-row">
            <td>صافي المبلغ المستحق بعد الخصم (رأس المال + الأرباح - التعثرات)</td>
