                    ...
                    <div key={index}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <div className="flex gap-2">
                            <select name={`kafeels[${index}][phoneCode]`} value={kafeel.phoneCode || '+966'} onChange={handleChange} onBlur={handleBlur} className={`${inputBase} w-28 shrink-0`}>
                              {countryCodes.map((c) => <option key={c.code} value={c.code}>{c.flag} {c.code}</option>)}
                            </select>
                            <input name={`kafeels[${index}][phone]`} value={kafeel.phone || ''} onChange={handleChange} onBlur={handleBlur} className={`${inputBase} text-left`} dir="ltr" />
                          </div>
