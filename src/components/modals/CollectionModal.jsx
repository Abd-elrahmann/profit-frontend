...
const CollectionModal = ({ 
  ...
  const defaultMessage = `مرحباً ${clientName}، نود تذكيرك بأن الدفعة بمبلغ ${installment?.amount?.toFixed(2) || '0.00'} ريال مستحق الدفع. يرجى استخدام الرابط التالي لإتمام عملية الدفع: ${paymentLink}`;
