...
<div class="contract-wrapper">
  <div class="contract-container">
    ...
    <div class="text-box">
      ...
      <p style="{{عرض_نص_فردي}}">
        أشهد أنا {{اسم_رب_المال}} بأنه قد تم استلام مبلغ وقدره {{المبلغ_رقما}}
        من العميل المذكور أعلاه كدفعة سداد.
        وقد تم استلام المبلغ نقداً/تحويلاً بنكياً وتعهد العميل بصحة المعلومات المذكورة أعلاه.
        ويُعد هذا الإيصال سندًا نظاميًا باستلام المبلغ المذكور، ولا يُفسَّر بأي حال على أنه مخالصة نهائية أو تنازل عن أي حقوق أخرى، إلا إذا ورد نصٌ صريحٌ بخلاف ذلك
      </p>
      <!-- Bulk installments text -->
      <p style="{{عرض_نص_مجمع}}">
        أشهد أنا {{اسم_رب_المال}} بأنه قد تم استلام مبلغ وقدره {{المبلغ_رقما}}
        من العميل المذكور أعلاه كدفعات سداد للدفعات الموضحة في الجدول أعلاه.
        وقد تم استلام المبلغ نقداً/تحويلاً بنكياً وتعهد العميل بصحة المعلومات المذكورة أعلاه.
        ويُعد هذا الإيصال سندًا نظاميًا باستلام المبلغ المذكور، ولا يُفسَّر بأي حال على أنه مخالصة نهائية أو تنازل عن أي حقوق أخرى، إلا إذا ورد نصٌ صريحٌ بخلاف ذلك
      </p>
    </div>
