...
<div class="contract-wrapper">
  <div class="contract-container">
    ...
    <div class="text-box">
      <p>
        أُقر أنا الموقع أدناه <span class="highlight-text">{{اسم_المستثمر}}</span>، بأن السيد <span class="highlight-text">{{اسم_العميل}}</span> رقم الهوية الوطنية: <span class="highlight-text">{{رقم_هوية_العميل}}</span> قد قام بسداد كامل مبلغ السلفة الممنوحة له بموجب: • سند أمر رقم (<span class="highlight-text">{{رقم_السند}}</span>) • إقرار دين وتعهد بالسداد رقم (<span class="highlight-text">{{رقم_الإقرار}}</span>) وذلك بمبلغ وقدره (<span class="highlight-text">{{المبلغ_كتابة}}</span>) {{معلومات_الخصم}} فقط لا غير. وبناءً على ذلك، فقد تم استلام المبلغ كاملًا وتُعتبر هذه السلفة مقفلة نهائيًا، ولا يترتب على السيد {{اسم_العميل}} أي التزامات مالية أخرى تخص السلفة أو السند المشار إليهما أعلاه. ويُعد هذا الإشعار خلو طرف نهائي صادر بناءً على السداد الكامل والمطابقة مع المستندات الرسمية.
      </p>
    </div>
