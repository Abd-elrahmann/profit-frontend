...
const PeriodsAdvancedSearch = ({
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Modal open={open} onClose={onClose} aria-labelledby="advanced-search-modal">
        <Box
          sx={{
            position: 'absolute',
            top: '50%',
          ...
          <Stack spacing={3}>
            ...
            <Box>
              <FormControl component="fieldset">
                ...
                >
                  <FormControlLabel value="all" control={<Radio size="small" />} label="الكل" />
                  <FormControlLabel value="false" control={<Radio size="small" />} label="مفتوحة" />
                  <FormControlLabel value="true" control={<Radio size="small" />} label="مقفلة" />
                </RadioGroup>
              </FormControl>
            </Box>
            <Box>
